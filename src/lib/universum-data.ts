...
export const PRODUCTS: Product[] = [
  {
    ...
    papers: [
      { 
        ...
        doi: "10.1016/j.ridd.2005.03.003", 
        note: "n=150, r = 0.82",
  ...
  },
  {
    ...
    papers: [
      { title: "Нейрофидбек при СДВГ: комплексный мета-анализ клинической эффективности", doi: "10.1177/1087054712460087", note: "мета-анализ", summary: "Мета-анализ подтверждает значимое снижение невнимательности и импульсивности у детей с СДВГ после курса нейрофидбек-тренировок." },
      { title: "Является ли нейрофидбек эффективным методом лечения СДВГ? Рандомизированное контролируемое клиническое исследование", doi: "10.1111/j.1469-7610.2008.02033.x", note: "n=102, p<0.001", summary: "РКИ (n=102): нейрофидбек превзошёл контрольный тренинг внимания по снижению симптомов СДВГ по оценкам родителей и педагогов." },
    ],
  ...
  },
  {
    ...
    papers: [
      { title: "Эффективность и интенсивность коррекции у детей с нарушениями звукопроизношения", doi: "10.1044/1092-4388(2012/11-0076)", note: "n=64", summary: "Показано, что регулярные интенсивные занятия ускоряют коррекцию звукопроизношения; важны частота и число повторений." },
      { title: "Распознавание детской речи: генеративное расширение данных", doi: "10.1109/asru46091.2019.9003933", note: "обзор технологий", summary: "Работа описывает методы повышения точности автоматического распознавания детской речи — основы цифровых логопедических тренажёров." },
    ],
  ...
  },
  {
    ...
    papers: [
      { title: "Виртуальная реальность: потенциал обучения социальным навыкам при РАС", doi: "10.1007/s10803-015-2497-3", note: "n=27", summary: "Тренинг социальных навыков в виртуальной реальности улучшил распознавание эмоций и навыки общения у молодых людей с РАС." },
      { title: "Виртуальная реальность для улучшения социальных навыков у детей и подростков с аутизмом: систематический обзор", doi: "10.1016/j.chb.2018.06.014", note: "систематический обзор", summary: "Систематический обзор: VR-вмешательства дают устойчивый прирост социальных и коммуникативных навыков у детей и подростков с аутизмом." },
    ],
  ...
  },
  {
    ...
    papers: [{ title: "Обзор терапии сенсорной интеграции", doi: "10.5014/ajot.2015.018051", note: "обзор", summary: "Обзор подтверждает эффективность сенсорной интеграции для достижения индивидуальных целей и снижения сенсорных трудностей у детей." }],
  ...
  },
  {
    ...
    papers: [{ title: "Ультразвуковая визуальная обратная связь в артикуляционной терапии детей", doi: "10.1111/1460-6984.70209", note: "n=38", summary: "Мета-анализ: ультразвуковая визуальная обратная связь улучшает точность артикуляции у детей с устойчивыми нарушениями речи." }],
  ...
  },
  {
    ...
    papers: [{ title: "Тренировка рабочей памяти", doi: "10.1016/j.tics.2010.05.002", note: "обзор", summary: "Обзор показывает, что тренировка рабочей памяти улучшает выполнение тренируемых задач; перенос на другие навыки требует контроля." }],
  ...
  },
  {
    ...
    papers: [{ title: "Обучение распознаванию эмоций", doi: "10.1017/S0954579406060305", note: "n=41", summary: "Изучены механизмы распознавания эмоций у детей и эффективность обучения чтению мимики и эмоциональных сигналов." }],
    integrations: ["API v2.1"],
  },
  {
    id: "bos-breath",
    ...
    papers: [{ title: "Биофидбек ВСР и тревожность", doi: "10.1007/s10484-013-9217-6", note: "n=44", summary: "Биофидбек вариабельности сердечного ритма снижает уровень тревожности и улучшает саморегуляцию." }],
  ...
  },
  {
    ...
    papers: [{ title: "Peer-mediated interventions", doi: "10.1111/j.1469-7610.2010.02289.x", note: "n=60", summary: "Вмешательства с участием сверстников улучшили социальную вовлечённость детей с РАС в школьной среде." }],
    integrations: ["API v2.1"],
  },
];
